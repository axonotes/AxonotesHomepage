...
<div class="container mx-auto px-4 py-8">
    ...
    <header class="mb-16 text-center">
        ...
        <div class="mx-auto max-w-3xl space-y-4">
            ...
            <p class="text-surface-600 dark:text-surface-400 text-sm">
                <strong>Our Philosophy:</strong> Essential academic tools should be
                free. Premium features should be affordable. Institutions should
        ...
        >
            <div class="grid gap-8 md:grid-cols-3">
                ...
                <div class="text-center">
                    ...
                    >
                        <span class="text-tertiary-600 dark:text-tertiary-400 text-lg font-bold">∞</span>
                    </div>
                    <h3
                            class="text-surface-900 dark:text-surface-100 text-md mb-2 font-semibold"
                    >
    ...
    <section class="mb-16">
        <h2
                class="text-surface-900 dark:text-surface-100 mb-2 text-center text-xl md:text-2xl font-bold"
        >
            Choose Your Plan
        </h2>
        <p class="text-surface-600 dark:text-surface-400 mb-12 text-center text-sm">
            All plans include our core academic features. Upgrade for enhanced capabilities and to support development.
        </p>
        ...
        >
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-surface-700 dark:text-surface-300 text-sm">
                        These plans represent our current vision. Final features, storage limits,
                        and pricing may evolve as we develop and refine Axonotes based on community feedback.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="text-center">
        ...
        <p class="text-surface-700 dark:text-surface-300 mx-auto mb-6 max-w-2xl">
            We're building Axonotes with transparency in mind. Have questions about
            our pricing model or need a custom solution?
        </p>
